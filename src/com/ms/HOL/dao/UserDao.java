...
public static Connection getConnection(){
	...
	try{
		...
		con=DriverManager.getConnection(System.getenv("azure.mysql.url" ),System.getenv("azure.mysql.username" ), System.getenv("azure.mysql.password" ));
